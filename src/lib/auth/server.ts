...
// The public preview client id can be a source fallback, but its secret must be
// injected. Without it federated auth stays disabled rather than leaking a
// credential through source control.
...
// Local `npm run dev` origins. Browsers may send Origin as any of
